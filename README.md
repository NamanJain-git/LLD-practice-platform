...
🌐 **Frontend:**  
https://lld-practice-platform-project.netlify.app/

### Backend

⚙️ **Backend API:**  
https://lld-practice-platform-pink.vercel.app

🔌 **Production API Base URL:**  
https://lld-practice-platform-pink.vercel.app/api

🔎 **Problems API:**  
https://lld-practice-platform-pink.vercel.app/api/problems

### Source Code

💻 **GitHub Repository:**  
https://github.com/NamanJain-git/LLD-practice-platform

---

## 🚀 Deployment Architecture

The application is deployed using a simple full-stack architecture:
...
Stores LLD practice problems, including:
...
Stores learner practice attempts and their current evaluation status.

* submissions

Stores the learner's submitted LLD solution.

* evaluations

Stores structured evaluation results, including:
...
The seed script uses the MONGO_URI environment variable to connect to the configured MongoDB database.
...
VITE_API_URL=https://lld-practice-platform-pink.vercel.app/api
